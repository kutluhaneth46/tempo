...
/// Per-connection Reth ingress backlog for `tempo/1`.
///
/// At the protocol's maximum frame size this occupies at most 64 KiB, enough
/// for short scheduling stalls without consuming much of the shared RLPx budget.
